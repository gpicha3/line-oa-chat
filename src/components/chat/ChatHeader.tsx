        ...
        <>
          ...
          <div className="absolute top-full right-4 mt-1 w-48 bg-white border border-gray-200 rounded-xl shadow-lg z-40 overflow-hidden animate-in fade-in zoom-in duration-200">
            <ul className="text-sm">
              <li className="px-4 py-3 hover:bg-gray-50 cursor-pointer" onClick={() => setIsMenuOpen(false)}>
                <div className='flex items-center gap-2'>
                  <img src={"https://rocket.in.th/wp-content/uploads/2023/03/%E0%B8%AA%E0%B8%A3%E0%B8%B8%E0%B8%9B-Line-Official-Account.png"} className="w-9 h-9 object-cover rounded-full"/>
                  Link to LineOA
                </div>
              </li>
              <li className="px-4 py-3 hover:bg-gray-50 cursor-pointer" onClick={() => setIsMenuOpen(false)}>
                <div className='flex items-center gap-2'>
                  <img src={"https://cdn.pixabay.com/photo/2022/01/30/13/33/github-6980894_640.png"} className="w-9 h-9 object-cover rounded-full"/>
                  Link to Github
                </div>
              </li>
            </ul>
